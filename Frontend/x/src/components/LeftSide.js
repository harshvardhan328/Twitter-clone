...
const LeftSide = () => {
    ...
    return (
        <div className='w-[22%]' style={{ backgroundColor: '#f3f4f6' }}>
            <div>
                <div>
                    <img className='ml-3' width={"24px"} src="https://www.edigitalagency.com.au/wp-content/uploads/new-Twitter-logo-x-black-png-1200x1227.png" alt="twitter-logo" />
                </div>
                <div className='my-4'>
                    ...
                    <Link to={`/message/${user?._id}`} className='flex items-center my-2 px-4 py-2 hover:bg-gray-200 hover:cursor-pointer rounded-full'>
                        <div>
